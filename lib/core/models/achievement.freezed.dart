...
class _$AchievementImpl implements _Achievement {
  ...
  @override
  String toString() {
    return 'Achievement(id: $id, title: $title, description: $description, icon: $icon, earned: $earned, earnedDate: $earnedDate, xpReward: $xpReward)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, description, icon, earned, earnedDate, xpReward);
...
abstract class _Achievement implements Achievement {
  const factory _Achievement(
      ...
      final DateTime? earnedDate,
      required final int xpReward}) = _$AchievementImpl;
